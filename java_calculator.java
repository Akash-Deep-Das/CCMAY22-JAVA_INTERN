...
/*********************************************
 Save this file as java_calculator.java
 to compile it use
...
public class java_calculator extends Frame
{
    ...
    ///////////////////////////
    java_calculator(String frameText)//constructor
    {
        super(frameText);
...
//set Co-ordinates for Operator Buttons
    ...
    {
        new java_calculator("Calculator - JavaTpoint");
    }
}
...
class MyDigitButton extends Button implements ActionListener
{
    ...
    //////////////////////////////////////////
    MyDigitButton(int x,int y, int width,int height,String cap, java_calculator clc)
    {
        super(cap);
...
class MyOperatorButton extends Button implements ActionListener
{
    ...
    MyOperatorButton(int x,int y, int width,int height,String cap, java_calculator clc)
    {
        super(cap);
        setBounds(x,y,width,height);
        this.cl=clc;
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        if(opText.equals("1/x"))
        {
            ...
            {double tempd=1/(double)temp;
                cl.displayLabel.setText(java_calculator.getFormattedText(tempd));}
...
// process = button pressed
        ...
        cl.displayLabel.setText(java_calculator.getFormattedText(temp));
//cl.number=temp;
    }//actionPerformed
}//class
...
class MyMemoryButton extends Button implements ActionListener
{
    ...
    /////////////////////////////////
    MyMemoryButton(int x,int y, int width,int height,String cap, java_calculator clc)
    {
        super(cap);
        setBounds(x,y,width,height);
        this.cl=clc;
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        switch(memop)
        {
            ...
            case 'R':
                cl.displayLabel.setText(java_calculator.getFormattedText(cl.memValue));break;
            case 'S':
                cl.memValue=0.0;
            case '+':
...
class MySpecialButton extends Button implements ActionListener
{
    ...
    MySpecialButton(int x,int y, int width,int height,String cap, java_calculator clc)
    {
        super(cap);
        setBounds(x,y,width,height);
        this.cl=clc;
